...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-pto-%f+i7+k0v8cgxo&*)ldbat&+n9gbpk5&ux&y%0!5j6&iy2')
...
# Database — uses DATABASE_URL env var in production (Railway sets this automatically)
